...
export const CAPABILITIES_DATA: readonly CapabilityItem[] = [
  {
    id: "frontend",
    icon: <DevicesIcon sx={{ fontSize: 32 }} className="text-primary dark:text-orange" />,
  ...
  {
    id: "fullstack",
    icon: <LayersIcon sx={{ fontSize: 32 }} className="text-primary dark:text-orange" />,
  ...
  {
    id: "maintainability",
    icon: <VerifiedUserIcon sx={{ fontSize: 32 }} className="text-primary dark:text-orange" />,
...
export default function Capabilities() {
  ...
  return (
    <section
      id="capabilities"
      aria-label={t("title")}
      className="mt-28 w-full flex flex-col items-center px-4 sm:px-6 lg:px-8"
    >
      ...
      <div className="mt-10 grid w-full max-w-6xl grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <article className="group relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-neutral-200/90 bg-white/95 p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-xl motion-reduce:transition-none motion-reduce:hover:translate-y-0 motion-reduce:hover:shadow-sm dark:border-neutral-700/80 dark:bg-neutral-900/90">
              ...
              <div className="relative flex flex-col gap-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-neutral-100 dark:bg-neutral-800 border border-neutral-200/60 dark:border-neutral-700/60">
                  {item.icon}
                </div>
